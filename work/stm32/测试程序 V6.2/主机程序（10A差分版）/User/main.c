		...
		if ( time == cir_sec * 1000 ) // 1000 * 1 ms = 1s 时间到      
    {
	    ...
	    data[1]=U_dis / 100;
			...
			if( flag != 0xff )
			{
				...
				Ut = (float) (0x100 * RxMessage.Data[3] + RxMessage.Data[2]) / 4095 * REF_VOL;     //电池电压		
//				U2 = (float) (0x100 * RxMessage.Data[3] + RxMessage.Data[2]) / 4095 * REF_VOL;     //半差电压
				...
				U2 = U1-U3;
				I = (float)U_dis/88;
				printf("%5d  %8d   %11.3f   %11.3f   %10.3f  %11.3f  %6.2f\r\n", i , time_0 , U1 , U2 , U3 ,Ut , I);
