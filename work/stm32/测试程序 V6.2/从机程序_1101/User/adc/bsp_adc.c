...
//	ntimes3 = FRE_NUM;
	...
	BAT1_ADC_Valt = (uint32_t)((float)value/ntimes);
...
//			for (i = 0; i<FRE_NUM; i++)
//			{
//				value1 += ADC_ConvertedValueLocalt[i];
//			}
//			BAT1_ADC_Valt = (uint32_t)((float)value/ntimes1);
//			for (i = 0; i<FRE_NUM; i++)
//			{
//				value2 += ADC_ConvertedValueLocalt2[i];
//			}
//			BAT1_ADC_Valt = (uint32_t)((float)value/ntimes2);
...
{
	int i=0;
	uint32_t value1=0 ,value2=0, value3=0 , dU_Current_0, dU_Current_1;
	BAT1_ADC_Val1 = 0;
	BAT1_ADC_Val2 = 0;
...
//		(dU_Current_0 - dU_Current_1)
		dU_Current_1 = ADC_test_return();
		if((dU_Current_0 - dU_Current_1)>2.5)
		{
			break;
		}
		dU_Current_0 = dU_Current_1;
