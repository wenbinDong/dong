...
static void ADC_NVIC_Config(void)
{
	  ...
	  NVIC_PriorityGroupConfig(NVIC_PriorityGroup_1);
	 	/*中断设置*/
	  adc1_nvic.NVIC_IRQChannel = ADC1_2_IRQn;	   //ADC1中断
    adc1_nvic.NVIC_IRQChannelPreemptionPriority = 1;		   //抢占优先级0
    adc1_nvic.NVIC_IRQChannelSubPriority = 1;			   //子优先级为0
