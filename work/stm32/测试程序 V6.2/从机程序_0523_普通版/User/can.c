...
{	  
  ...
  TxMessage.ExtId=0x41;					 //使用的扩展ID
  TxMessage.IDE=CAN_ID_EXT;					 //扩展模式
  TxMessage.RTR=CAN_RTR_DATA;				 //发送的是数据
  TxMessage.DLC=6;							 //数据长度为2字节
  TxMessage.Data[0]=val1;
  TxMessage.Data[1]=val2;
	TxMessage.Data[2]=val3;
  TxMessage.Data[3]=val4;
	TxMessage.Data[4]=val5;
  TxMessage.Data[5]=val6;
}
